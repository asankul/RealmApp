...
class TaskListViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let countOfCurrentTasks = taskList.tasks.filter { !$0.isComplete }.count
        if countOfCurrentTasks > 0 || taskList.tasks.isEmpty {
            content.secondaryText = "\(countOfCurrentTasks)"
